...
Route::get('/certificate/list', [CertificateController::class, 'userListView'])->name('certificate.list')->middleware(['auth']);
...
Route::post('/certificate/add', [CertificateController::class, 'addEvent'])->middleware(['auth','UserIsAdmin']);
